...
import com.example.socialmedia.daos.Utils
...
class PostAdapter(option : FirestoreRecyclerOptions<Post>, val listener: IpostAdapter) : FirestoreRecyclerAdapter<Post,PostAdapter.PostViewHolder>(option) {
